...
require_once 'modelos/ModeloCarrito.php'; /*importa el modelo */
class CarritoDao
{
   ...
   /*Metodo que obtiene todos los productos de la base de datos, retorna una lista de objetos */
	...
	public function editar(ModeloDeseado $obj)
	{
		try 
		{
	...
	public function agregarACarrito(ModeloCarrito $obj)
	{
        $clave=0;
		try 
		{
            $sql = "INSERT INTO carrito (`IDUsuario`,`IDLibro`,`Libro`,`Precio`)
			 values(?, ?, ?, ?)";   
            $this->conectar();
